...
public class SubmitMessageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (int i = 0; i < ForumPosts.size(); i++) {
			out.println("<fieldset><legend><b> " + ForumPosts.get(i).getName() + "</b><i> says </i> </legend>"
					+ ForumPosts.get(i).getMessage() + "<br><small><i>" + ForumPosts.get(i).getTimeStamp()
					+ "</i></small></fieldset><br>");
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// Create time stamp
		String timeStamp = "" + calendar.get(Calendar.DATE) + "/" + (Integer.valueOf(calendar.get(Calendar.MONTH)) + 1)
